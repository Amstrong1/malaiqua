    ...
    <main class="container mx-auto p-4">
        <div class="bg-white p-6">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold mb-4">Hôtel Les Orchidées</h1>
                <a href="/comment">
            ...
            <form>
                ...
                <div class="mt-4 mb-6 space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border rounded p-4">
                            <p class="text-sm font-semibold">Chambre Double Classique</p>
                            <p class="text-sm">Compris dans votre chambre :</p>
                            <ul class="list-disc list-inside">
                                <li>Boissons de bienvenue gratuites</li>
                                <li>Wi-Fi gratuit</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button @click="setData()" type="button"
                        class="bg-blue-500 text-white px-6 py-2 rounded-lg">Confirmer et payer maintenant</button>
                </div>
            </form>
        </div>
    </main>
